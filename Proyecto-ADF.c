...
struct nodoAlumno *crearAlumno(char *nombre,char *rut , int ingreso)
{
    ...
    nuevoAlumno->alumnno->nombre = nombre;
    nuevoAlumno->alumnno->rut = rut;
...
struct nodoAsignatura *crearAsignatura(char *nombre,int id , char *profesor)
{
    ...
    nuevoAsignatura->datosAsignatura->nombre =nombre;
    nuevoAsignatura->datosAsignatura->id=id;
    nuevoAsignatura->datosAsignatura->profesor=profesor;
...
char *faltaMasComun (struct nodoAsignatura *asignatura)
{
    i=0 
